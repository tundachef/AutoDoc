...
<head>
    ...
    <style media="all">
        ...
        * html .footer {
        ...
        .border-bottom td,
        .border-bottom th {
            border-bottom: 0px solid #2D7BFF;
        }
    ...
    <table class="content-position">
        <tr>
            ...
            <th style="text-align: right">
                <h1 style="color: #030303; margin-bottom: 0px; font-size: 30px">INVOICE</h1>
            </th>
        </tr>
    </table>
    ...
    <table class="bs-0">
        <tr>
            <th class="bg-primary content-position-y" style="padding-right: 0; height: 44px; text-align: left">
                <div>
                    <span class="h4 inline text-white">INVOICE # </span>
                    <span class="inline">
            ...
            <th class="bg-secondary content-position-y" style="text-align: right; height: 44px;">
                <span class="h4 inline" style="color: #030303;padding-right: 15px;">Date</span>
                <span class="inline h4">
                    <strong style="color: #030303; ">{{date('y-m-d',strtotime($order['created_at']))}}</strong>
                </span>
            </th>
        </tr>
    </table>
        ...
        <table class="content-position-y" style="width: 100%">
            <tr>
                <td style="vertical-align: text-top;width: 130px; padding-left: 0;">
                    <span class="h2" style="margin: 0px;">Invoice To: </span>
                </td>
                <td>
...
<div class="row" style="margin: 20px 0; display:block; height:auto !important ;">
    <div class=" content-height content-position-y" style="">
        <table class="customers bs-0">
            <thead>
            <tr class="for-th">
                <th class="for-th bg-primary">No.</th>
                <th class="for-th bg-primary">Item Description</th>
            ...
            <th style="text-align: right">
                <table style="width: 46%;margin-left:41%; display: inline " class="text-right sm-padding strong bs-0">
                    ...
                    <tr style="background-color: #2D7BFF">
                        <th class="gry-color text-left strong text-white"><b>Total</b></th>
        ...
        <table style="width: 100%">
            <tr>
                <th class="content-position-y bg-primary"
                    ...
                    <div class="text-white" style="padding-top:5px; padding-bottom:2px;"><i  class="fa fa-phone text-white"></i> Phone : {{\App\Model\BusinessSetting::where('type','company_phone')->first()->value}}</div>
                    <div class="text-white" style="padding-top:5px; padding-bottom:2px;"><i  class="fa fa-globe text-white" aria-hidden="true"></i>  Website : {{url('/')}}</div>
                    <div class="text-white" style="padding-top:5px; padding-bottom:2px;"><i  class="fa fa-envelope text-white" aria-hidden="true"></i>  Email : {{$company_email}}</div>
                </th>
