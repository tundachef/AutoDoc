                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    ...
                                    <div class="input-group input-group-merge input-group-flush">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                            placeholder="Search by Order Id" aria-label="Search orders" value="{{ $search }}" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($order->payment_status=='paid')
                                                ...
                                                <span class="legend-indicator bg-success" style="{{Session::get('direction') === "rtl" ? 'margin-right: 0;margin-left: .4375rem;' : 'margin-left: 0;margin-right: .4375rem;'}}"></span>Paid
                                                </span>
                                            @else
                                                <span class="badge badge-soft-danger">
                                                <span class="legend-indicator bg-danger" style="{{Session::get('direction') === "rtl" ? 'margin-right: 0;margin-left: .4375rem;' : 'margin-left: 0;margin-right: .4375rem;'}}"></span>Unpaid
                                                </span>
                                            @endif
                                            </td>
                                            <td class="text-capitalize ">
                                                ...
                                                @elseif($order->order_status=='returned')
                                                    <label
                                                        class="badge badge-danger">{{str_replace('_',' ',$order['order_status'])}}</label>
                                                @else
                                                    <label
                                                        class="badge badge-danger">{{str_replace('_',' ',$order['order_status'])}}</label>
                                                @endif
