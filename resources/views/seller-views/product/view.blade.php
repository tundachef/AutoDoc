                    ...
                    <div class="col-md">
                        ...
                        <!-- Review Ratings -->
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span
                                    class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">5 star</span>
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">4 star</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">3 star</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">2 star</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">1 star</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
