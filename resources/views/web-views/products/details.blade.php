                ...
                <div class="details">
                    ...
                    <form id="add-to-cart-form" class="mb-2">
                        ...
                        <div class="position-relative {{Session::get('direction') === "rtl" ? 'ml-n4' : 'mr-n4'}} mb-3">
                            @if (count(json_decode($product->colors)) > 0)
                                <div class="flex-start">
                                    ...
                                    <div>
                                        <ul class="list-inline checkbox-color mb-1 flex-start px-0 {{Session::get('direction') === "rtl" ? 'mr-5' : 'ml-5'}}">
                        ...
                        @foreach (json_decode($product->choice_options) as $key => $choice)
                            <div class="flex-start">
                                <div class="product-description-label mt-2 {{Session::get('direction') === "rtl" ? 'pl-2' : 'pr-2'}}">{{ $choice->title }}:
                                </div>
                                <div>
                                            ...
                                            <h5 class="mb-0">
                                                <a href="javascript:" style="font-size: 15px" class="collapsed"
                                                   ...
                                                   aria-controls="collapseTwo">
                                                    {{\App\CPU\translate('Select')}} {{\App\CPU\translate('shipping_method')}}
                                                </a>
                                            </h5>
                                        </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <img style="max-height: 64px;"
                                                                     ...
                                                                     onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                                     src="{{asset("storage/profile/".(isset($productReview->user)?$productReview->user->image:'not exist'))}}"
                                                            ...
                                                            @if (!empty(json_decode($productReview->attachment)))
                                                                @foreach (json_decode($productReview->attachment) as $key => $photo)
                                                                    <img
                                                                        ...
                                                                        onclick="showInstaImage('{{asset("storage/$photo")}}')"
                                                                        class="cz-image-zoom"
                                                                        onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
