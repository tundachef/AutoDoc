...
@push('css_or_js')
    ...
    <style>
        ...
        @media (max-width: 600px) {
            ...
            .btn-b {
                width: 350px;
                margin-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}: 30px;
                margin-bottom: 10px;
                        ...
                        <section class="col-lg-6 col-md-6 mb-4 mt-5">
                            <div class="card" style="text-transform: capitalize;">
                                {{-- <div class="card cardColor"> --}}
                                    ...
                                    <div class="card-body" style="padding: {{Session::get('direction') === "rtl" ? '0 13px 15px 15px' : '0 15px 15px 13px'}}; border: 1px solid {{$web_config['primary_color']}};">
