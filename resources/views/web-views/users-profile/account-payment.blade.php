...
@section('content')
    <!-- Add Payment Method-->
    <form class="needs-validation modal fade rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" method="post" id="add-payment" tabindex="-1" novalidate>
    ...
    <div class="page-title-overlap bg-dark pt-4 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
            ...
            <div class="order-lg-1 {{Session::get('direction') === "rtl" ? 'pl-lg-4 text-lg-right' : 'pr-lg-4 text-lg-left'}} text-center">
        ...
        <div class="row">
            ...
            <section class="col-lg-8">
                ...
                <div class="d-none d-lg-flex justify-content-between align-items-center pt-lg-3 pb-4 pb-lg-5 mb-lg-4">
                    <h6 class="font-size-base text-light mb-0">Primary payment method is used by default</h6><a class="btn btn-primary btn-sm" href="{{route('customer.auth.logout')}}"><i class="czi-sign-out {{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}"></i>Sign out</a>
                </div>
                ...
                <div class="table-responsive font-size-md">
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            ...
                            <td class="py-3 align-middle"><a class="nav-link-style {{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}" href="#" data-toggle="tooltip" title="Edit"><i class="czi-edit"></i></a><a class="nav-link-style text-danger" href="#" data-toggle="tooltip" title="Remove">
                ...
                <hr class="pb-4">
                <div class="text-sm-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}"><a class="btn btn-primary" href="#add-payment" data-toggle="modal">Add payment method</a></div>
            </section>
        </div>
    </div>
