                        ...
                        <div class="inbox_people">
                            <div class="headind_srch">
                                <form
                                    ...
                                    <input class="form-control form-control-sm {{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}} w-75" id="myInput" type="text"
                                           placeholder="Search"
                                           aria-label="Search">
                                    ...
                                    <div class="type_msg">
                                        <div class="input_msg_write">
                                            <form
                                                ...
                                                <input class="form-control form-control-sm {{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}} w-75" id="msgInputValue"
                                                       type="text" placeholder="Send a message" aria-label="Search">
