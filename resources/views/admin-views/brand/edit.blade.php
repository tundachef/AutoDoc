...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{ \App\CPU\translate('Brand_update')}}</li>
        </ol>
    </nav>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h1 class="h3 mb-0 text-black-50">{{ \App\CPU\translate('Brand_update')}}</h1>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="brand">{{ \App\CPU\translate('brand_logo')}}</label><span class="badge badge-soft-danger">( ratio 1:1 )</span>
                                    <br>
