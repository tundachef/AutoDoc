...
@push('css_or_js')
    ...
    <link href="{{asset('assets/back-end/croppie.css')}}" rel="stylesheet">
                            ...
                            <div class="col-md-6">
                                @foreach(json_decode($language) as $lang)
                                    <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form" 
                                        ...
                                        <input type="text" name="name[]" class="form-control" id="name" value="{{old('name')}}" placeholder="Ex : LUX" {{$lang == $default_lang? 'required':''}}>
                                    </div>
                                    <input type="hidden" name="lang[]" value="{{$lang}}">
                                @endforeach
                                <div class="form-group">
                                    <label for="name">{{ \App\CPU\translate('brand_logo')}}</label><span class="badge badge-soft-danger">( ratio 1:1 )</span>
