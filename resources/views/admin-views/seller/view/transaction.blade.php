...
@section('title',$seller->shop ? $seller->shop->name : "shop name not found"."'s Transactions")
@push('css_or_js')
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    ...
                                    <div class="input-group input-group-merge input-group-flush">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                            placeholder="Search by orders id or transaction id" aria-label="Search orders" value="{{ $search }}"
                                            required>
