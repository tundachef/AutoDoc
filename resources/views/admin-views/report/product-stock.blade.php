                                ...
                                <div class="col-8">
                                    <div class="form-group">
                                        <select class="js-select2-custom form-control"
                                            ...
                                            <option value="in_house" {{$seller_is=='in_house'?'selected':''}}>In-House
                                            </option>
                    ...
                    <div class="card-body" id="products-table"
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col">
                                    Product Name <label class="badge badge-success ml-3"
                                                        style="cursor: pointer">ASE/DESC</label>
                                </th>
                                <th scope="col">
                                    Total Stock <label class="badge badge-success ml-3"
                                                       style="cursor: pointer">ASE/DESC</label>
                                </th>
                            </tr>
                            </thead>
