                                    ...
                                    @foreach(json_decode($language) as $lang)
                                        <div
                                            ...
                                            <label class="input-label"
                                                   for="exampleFormControlInput1">Sub {{\App\CPU\translate('sub_category')}} {{\App\CPU\translate('name')}}
                                    ...
                                    @else
                                        <div class="col-12">
                                            <div class="form-group lang_form" id="{{$default_lang}}-form">
                                                <label
                                                    class="input-label">Sub {{\App\CPU\translate('sub_category')}} {{\App\CPU\translate('name')}}
                                                    ({{strtoupper($lang)}})</label>
                                                <input type="text" name="name[]" class="form-control"
