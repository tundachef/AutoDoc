...
<div class="content container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h3 mb-0 text-black-50">{{\App\CPU\translate('Customer Message')}} {{\App\CPU\translate('List')}}</h1>
    </div>
                ...
                <div class="card-header">
                    ...
                    <div class="row justify-content-between align-items-center flex-grow-1">
                        <div class="flex-start col-lg-3 mb-3 mb-lg-0">
                            <h5>{{\App\CPU\translate('Customer Message')}} {{\App\CPU\translate('table')}} </h5>
                            ...
                            <form action="{{ url()->current() }}" method="GET">
                                <div class="input-group input-group-merge input-group-flush">
                                    ...
                                    <input id="datatableSearch_" type="search" name="search" class="form-control"
                                        placeholder="Search by Name or Mobile No or Email" aria-label="Search orders" value="{{ $search }}" required>
