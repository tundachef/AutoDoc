                        ...
                        <div class="card-body mt-3 ml-4">
                            <div class="row " style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                                ...
                                <div class=" col-md-9 col-lg-9 hidden-xs hidden-sm">
                                    ...
                                    @else
                                        <label
                                            style="color: red; border: 1px solid;padding: 2px;border-radius: 10px">{{\App\CPU\translate('Not Seen Yet')}}</label>
                                    @endif
                                    <br>
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if($contact['reply']!=null)
                                                ...
                                                <div class="flex-start">
                                                    <h6 class="{{Session::get('direction') === "rtl" ? 'ml-1' : 'mr-1'}}">Subject : </h6>
                                                    <h6>{{$data['subject']}}</h6>
                                                </div>
                                                <div class="flex-start">
                                                    <h6 class="{{Session::get('direction') === "rtl" ? 'ml-1' : 'mr-1'}}">Body : </h6>
                                                    <h6>{{$data['body']}}</h6>
                                                </div>
                                            @else
