                ...
                <div class="card-body" style="padding: 20px">
                    ...
                    <form action="{{route('admin.business-settings.payment-method.update',['ssl_commerz_payment'])}}"
                        ...
                        @if(isset($config))
                            ...
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{\App\CPU\translate('Store')}} {{\App\CPU\translate('ID')}} </label><br>
                                <input type="text" class="form-control" name="store_id" value="{{env('APP_MODE')=='demo'?'':$config['store_id']}}">
                            </div>
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{\App\CPU\translate('Store')}} {{\App\CPU\translate('password')}}</label><br>
            ...
            <div class="card">
                <div class="card-body" style="padding: 20px">
                    ...
                    <form action="{{route('admin.business-settings.payment-method.update',['paypal'])}}"
                        ...
                        @if(isset($config))
                            <div class="form-group mb-2">
                                <label class="control-label">{{\App\CPU\translate('Paypal')}} {{\App\CPU\translate('Payment')}}</label>
                            </div>
                            <div class="form-group mb-2 mt-2">
                                <input type="radio" name="status" value="1" {{$config['status']==1?'checked':''}}>
                                <label style="padding-left: 10px">{{\App\CPU\translate('Active')}}</label>
                            ...
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{\App\CPU\translate('Paypal')}} {{\App\CPU\translate('Client')}}{{\App\CPU\translate('ID')}}  </label><br>
                                <input type="text" class="form-control" name="paypal_client_id"
                                       value="{{env('APP_MODE')=='demo'?'':$config['paypal_client_id']}}">
                            </div>
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{\App\CPU\translate('Paypal')}} {{\App\CPU\translate('Secret')}} </label><br>
                ...
                <div class="card-body" style="padding: 20px">
                    ...
                    <form action="{{route('admin.business-settings.payment-method.update',['stripe'])}}"
                        ...
                        @if(isset($config))
                            ...
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{\App\CPU\translate('Published')}}{{\App\CPU\translate('Key')}}  </label><br>
                    ...
                    <form action="{{env('APP_MODE')!='demo'?route('admin.business-settings.payment-method.update',['senang_pay']):'javascript:'}}"
                        ...
                        @if(isset($config))
                            ...
                            <div class="form-group mb-2">
                                ...
                                <span class="btn btn-secondary btn-sm m-2" onclick="copyToClipboard('#id_senang_pay')"><i class="tio-copy"></i> Copy URI</span>
                                <br>
                ...
                <div class="card-body" style="padding: 20px">
                    ...
                    <form
                        ...
                        @if(isset($config))
                            ...
                            <div class="form-group mb-2">
                                <label style="padding-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}: 10px">{{\App\CPU\translate('Callback_URI')}}</label>
                                <span class="btn btn-secondary btn-sm m-2" onclick="copyToClipboard('#id_paystack')"><i class="tio-copy"></i> Copy URI</span>
                                <br>
                            ...
                            <div class="form-group mb-2">
                                <label style="padding-left: 10px">{{\App\CPU\translate('merchantEmail')}} </label><br>
