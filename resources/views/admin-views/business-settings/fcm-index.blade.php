                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}">Order Pending Message</span>
                                          </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}"> Order Confirmation Message</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}">Order Processing Message</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}">Order out for delivery Message</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}">Order Delivered Message</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}">Order Returned Message</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}">Order Failed Message</span>
                                              </span>
                                        </label>
