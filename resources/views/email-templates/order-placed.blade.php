            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailContainer"
                ...
                <tr>
                    ...
                    <td align="left" valign="top" colspan="2"
                        ...
                        <span style="font-size: 18px; font-weight: normal;">Notification mail for order placed</span>
                    </td>
                ...
                <tr>
                    ...
                    <td align="left" valign="top" colspan="2" style="padding-top: 10px;">
                        ...
                        <span style="font-size: 12px; line-height: 1.5; color: #333333;">
                            ...
                            We have sent you this email in response to your order placed. You will be able to see your order status after login to your account.
