...
class ProductController extends Controller
{
    ...
    public function add_new(Request $request)
    {
        ...
        return response()->json(['message' => 'successfully product added!'], 200);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->has('choice_no')) {
            foreach ($request->choice_no as $no) {
                $name = 'choice_options_' . $no;
                if ($request->has('choice_options_' . $no)) {
        ...
        return response()->json(['message' => 'successfully product updated!'], 200);
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return response()->json(['message' => 'successfully product deleted!'], 200);
    }
}
